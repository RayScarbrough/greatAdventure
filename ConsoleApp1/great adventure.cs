...
namespace greatAdventure
{
    class versionOne
    {
        ...
        {
            round ++;
            Console.WriteLine($"You completed round {round}!");
            Console.WriteLine($" Here is your current stats! Lives: {lives} Health: {health} Magic: {magic}");
        ...
        private static void actions(int num, ref int lives, ref int magic, ref int health)
        {
            switch (num)
            {
                ...
                case 2:
                    Console.WriteLine("You encountered a wicked witch who cursed you.");
                ...
                case 3:
                    Console.WriteLine("You fell into a pit filled with venomous snakes.");
                    Console.WriteLine("You lose 3 units of health");
                    health -= 3;
                    break;

                case 4:
                    Console.WriteLine("You accidentally drank a shrinking potion.");
                ...
                case 7:
                    Console.WriteLine("You stumble upon an abandond cabin. You find the cellar door and go in. In the cellar you find a chest with a magic and health potion!");
                ...
                case 8:
                    Console.WriteLine("You encountered a friendly dragon who granted you a wish.");
                    Console.WriteLine("You can choose to gain 4 units of health or 4 units of magic");
                    Console.WriteLine("Enter '1' for health or '2' for magic:");
                ...
                case 9:
                    Console.WriteLine("You were shot in the knee with an arrow but remarkable are still able to adventure!");
                    Console.WriteLine("You have lost 3 units of health and 1 life");
                    health -= 3;
                    lives -= 1;
                    break;
